...
import com.tick42.glue.desktop.notifications.NotificationSeverity;
...
public class NotificationsFrame extends JFrame {
    ...
    public void registerWithGlue(Glue glue) {
        ...
        WindowHandle<NotificationsFrame> handle = glue.windows().getWindowHandle(this);
        glue.windows()
                .register(handle)
    ...
    private void raiseNotification() {
        ...
        glue.notifications()
                .create("Example", notification -> notification
                        .title(title)
                        .details("showContacts"))
                .raise(NotificationSeverity.LOW);
    }
}
